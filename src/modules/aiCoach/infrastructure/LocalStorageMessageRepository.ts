...
type SessionsMap = Record<string, CoachingMessage[]>;
...
export class LocalStorageMessageRepository {
  public loadMessages(sessionId: string): ResultType<CoachingMessage[], "load-failed"> {

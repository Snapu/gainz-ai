...
import { createExerciseWeightMigrationRepository } from "@/modules/migration/infrastructure/sheetsRepository";
...
describe("exerciseWeightMigration service", () => {
  ...
  it("creates the sheet if it is missing", async () => {
    ...
    const result = await loadExerciseWeightMigrationReviews(

...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between w-full h-16 rounded-2xl border border-input/50 bg-card/50 overflow-hidden shadow-sm focus-within:ring-2 focus-within:ring-primary focus-within:border-primary transition-all backdrop-blur-sm">

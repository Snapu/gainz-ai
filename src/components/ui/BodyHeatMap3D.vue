...
const labels = ref<
  Array<{ group: MuscleGroup; x: number; y: number; sets: number; color: string }>
>([]);
...
function setupHighFidelityMannequin() {
  const createSegment = (
    ...
    const line = new THREE.LineSegments(
      edges,
      new THREE.LineBasicMaterial({ color: 0x22d3ee, transparent: true, opacity: 0.1 }),
    );
    mesh.add(line);
  ...
  createSegment(
    "Skeleton",
    new THREE.CylinderGeometry(0.08, 0.1, 0.2),
  ...
  createSegment(
    ...
    new THREE.Vector3(0.25, 1.4, 0.18),
  ...
  createSegment(
    ...
    new THREE.Vector3(0.25, 1.15, 0.18),
  ...
  createSegment(
    "Back",
    new THREE.BoxGeometry(0.45, 0.8, 0.15),
    new THREE.Vector3(0.3, 1.1, -0.15),
    new THREE.Euler(0, -0.2, 0.1),
  );
  createSegment(
    "Back",
    new THREE.BoxGeometry(0.45, 0.8, 0.15),
  ...
  for (let i = 0; i < 3; i++) {
    createSegment(
      ...
      new THREE.Vector3(0.12, 0.95 - i * 0.18, 0.15),
    );
    createSegment(
      "Abs",
      new THREE.BoxGeometry(0.2, 0.15, 0.1),
  ...
  createSegment(
    "Shoulders",
    deltGeo,
    new THREE.Vector3(0.65, 1.55, 0.1),
  ...
  createSegment(
    "Biceps",
    armGeo,
    new THREE.Vector3(-0.75, 1.15, 0.1),
    new THREE.Euler(0.2, 0, -0.1),
  );
  createSegment(
    "Triceps",
    armGeo,
    new THREE.Vector3(0.78, 1.1, -0.1),
    new THREE.Euler(-0.2, 0, 0.1),
  );
  createSegment(
    "Triceps",
  ...
  createSegment(
    "Skeleton",
    new THREE.CylinderGeometry(0.08, 0.06, 0.6),
    new THREE.Vector3(0.85, 0.6, 0.15),
  ...
  createSegment(
    "Glutes",
    gluteGeo,
    new THREE.Vector3(0.22, 0.45, -0.15),
  ...
  createSegment(
    "Quads",
    legGeo,
    new THREE.Vector3(0.28, -0.1, 0.15),
  ...
  createSegment(
    ...
    new THREE.Vector3(0.32, -1.4, 0.1),
  );
  createSegment(
    "Skeleton",
    new THREE.BoxGeometry(0.18, 0.08, 0.4),
...
function updateMaterials() {
  for (const group of ALL_GROUPS) {
    ...
    for (const mesh of groupMeshes) {
      ...
      if (
        status?.landmark === "at_MAV" ||
        status?.landmark === "approaching_MRV" ||
        status?.landmark === "above_MRV"
      ) {
